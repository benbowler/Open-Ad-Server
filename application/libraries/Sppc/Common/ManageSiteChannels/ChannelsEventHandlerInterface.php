...
interface Sppc_Common_ManageSiteChannels_ChannelsEventHandlerInterface {
	/**
	 ...
	 */
	public function extendColumnQueryFields(array $params, $tableName = 'stat_channels');
} //end interface Sppc_Publisher_ManageSiteChannels_ChannelsEventHandlerInterface
