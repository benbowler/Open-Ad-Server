	...
	function run()
	{
		...
		foreach ($this->_rules as $field => $rules)
		{
			...
			{			
                ...
                * перевод строки сообщения об ошибке на язык текущего пользователя
                */
               $message = sprintf(__($line), "{@$mfield@}");
               /* end Владимир Юдин */                										
			...
			foreach ($ex As $rule)
			{
               ...
               /**
               *  @author Владимир Юдин
               *  поддержка для вызовов глобальных функций в качестве валидатора поля 
               */
				   if ( ! method_exists($this->CI, $rule)) {
					...
					/**
					 * @author Владимир Юдин
					 * поддержка одновоеменной проверки нескольких правил валидации
					 */
                ...
                * перевод строки сообщения об ошибке на язык текущего пользователя
                */
					$message = sprintf(__($line), "{@$mfield@}", "{@$mparam@}");
               /* end Владимир Юдин */                
